...
class _VacationExpertAppState extends State<VacationExpertApp> {
  ...
  // Добавьте эти методы в класс _VacationExpertAppState
  ...
  String _getHotelsRecommendation(String country) {
    final recommendations = {
      ...
      'Греция': 'Отели на Санторини и Миконосе с видом на море',
      'Турция': 'Курортные отели в Анталии и Стамбуле',
      'Таиланд': 'Бунгало на Пхукете и Самуи',
      'ОАЭ': 'Роскошные отели в Дубае и Абу-Даби',
      'Португалия': 'Отели в Лиссабоне и на побережье Алгарве',
      'Чехия': 'Исторические отели в центре Праги',
      'Вьетнам': 'Отели в Ханое и курорты в Нячанге',
      'Мальдивы': 'Виллы на воде с приватным доступом к морю',
      'Канада':
          'Лоджи в национальных парках и городские отели в Торонто и Ванкувере',
    };
  ...
  String _getRestaurantsRecommendation(String country) {
    final recommendations = {
      ...
      'Греция': 'Таверны с мезе и морепродуктами',
      'Турция': 'Рестораны с кебабами и восточными сладостями',
      'Таиланд': 'Уличная еда и рестораны с том-ямом',
      'ОАЭ': 'Международная кухня в роскошных ресторанах',
      'Португалия': 'Рестораны с бакальяу и морепродуктами',
      'Чехия': 'Пивные рестораны с традиционной кухней',
      'Вьетнам': 'Уличная еда и рестораны с фо',
      'Мальдивы': 'Рестораны с морепродуктами на пляже',
      'Канада':
          'Рестораны с морепродуктами, стейк-хаусы и интернациональная кухня',
    };
  ...
  String _getSightsRecommendation(String country) {
    final recommendations = {
      ...
      'Греция': 'Акрополь, Санторини, Миконос, Метеоры',
      'Турция': 'Стамбул, Каппадокия, Памуккале, Эфес',
      'Таиланд': 'Бангкок, Пхукет, храмы, острова',
      'ОАЭ': 'Бурдж-Халифа, Дубай Молл, пустынные сафари',
      'Португалия': 'Лиссабон, Синтра, Порту, побережье Алгарве',
      'Чехия': 'Пражский Град, Карлов мост, старый город',
      'Вьетнам': 'Ханой, бухта Халонг, Хойан, Сапа',
      'Мальдивы': 'Дайвинг, сноркелинг, пляжный отдых',
      'Канада':
          'Ниагарский водопад, Скалистые горы, национальные парки, Торонто, Ванкувер',
    };
    return recommendations[country] ??
  ...
  String _getTipsRecommendation(String country) {
    final tips = {
      ...
      'Греция': 'Посещать острова, пробовать оливковое масло',
      'Турция': 'Торговаться на базарах, пробовать турецкий кофе',
      'Таиланд':
          'Уважать королевскую семью, посещать храмы в соответствующей одежде',
      'ОАЭ':
          'Соблюдать местные законы, одеваться скромно в общественных местах',
      'Португалия': 'Пробовать портвейн, посещать смотровые площадки',
      'Чехия': 'Пробовать местное пиво, носить удобную обувь для прогулок',
      'Вьетнам': 'Торговаться на рынках, пробовать уличную еду',
      'Мальдивы':
          'Бронировать трансфер заранее, использовать солнцезащитный крем',
      'Канада':
          'Планировать маршрут между городами, брать теплую одежду даже летом',
    };
